...
public class DynamoDbStreamsSource<T>
    ...
    /**
     * Create a {@link DynamoDbStreamsSourceBuilder} to allow the fluent construction of a new {@link
     * DynamoDbStreamsSource}.
     *
    ...
    @Override
    public SourceReader<T, DynamoDbStreamsShardSplit> createReader(SourceReaderContext readerContext)
            throws Exception {
        ...
        Supplier<PollingDynamoDbStreamsShardSplitReader> splitReaderSupplier =
                () -> new PollingDynamoDbStreamsShardSplitReader(createDynamoDbStreamsProxy(sourceConfig));
    ...
    @Override
    public SplitEnumerator<DynamoDbStreamsShardSplit, DynamoDbStreamsSourceEnumeratorState> createEnumerator(
            SplitEnumeratorContext<DynamoDbStreamsShardSplit> enumContext) throws Exception {
    ...
    public SimpleVersionedSerializer<DynamoDbStreamsSourceEnumeratorState>
        ...
        return new DynamoDbStreamsSourceEnumeratorStateSerializer(new DynamoDbStreamsShardSplitSerializer());
    }
    ...
    private DynamoDbStreamsProxy createDynamoDbStreamsProxy(Configuration consumerConfig) {
        ...
        DynamoDbStreamsClient dynamoDbStreamsClient =
                AWSClientUtil.createAwsSyncClient(
                        ...
                        DynamodbStreamsSourceConfigConstants.BASE_DDB_STREAMS_USER_AGENT_PREFIX_FORMAT,
