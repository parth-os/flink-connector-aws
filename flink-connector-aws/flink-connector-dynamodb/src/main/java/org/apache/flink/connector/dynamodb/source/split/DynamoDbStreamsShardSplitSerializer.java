 ...
 */
@Internal
public class DynamoDbStreamsShardSplitSerializer implements SimpleVersionedSerializer<DynamoDbStreamsShardSplit> {
    ...
    @Override
    public DynamoDbStreamsShardSplit deserialize(int version, byte[] serialized) throws IOException {
